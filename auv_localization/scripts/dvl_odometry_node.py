...
class DvlToOdom:
    def __init__(self):
        ...
        self.velocity_subscriber = rospy.Subscriber("sensors/dvl/velocity_raw", Twist, self.velocity_callback)
    ...
    def load_calibration_data(self):
        ...
        try:
            with open(config_path, 'r') as f:
                ...
                self.odom_msg.twist.covariance[0] = calibration_data.get('twist_covariance_linear_x', 0.01)
                self.odom_msg.twist.covariance[7] = calibration_data.get('twist_covariance_linear_y', 0.01)
                self.odom_msg.twist.covariance[14] = calibration_data.get('twist_covariance_linear_z', 0.01)
            ...
            rospy.loginfo("No calibration data found. Using default covariances.")
