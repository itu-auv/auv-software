...
class TorpedoTransformServiceNode:
    def __init__(self):
        ...
        self.torpedo_closer_frame = rospy.get_param(
            "~torpedo_closer_frame", "torpedo_close"
        )
        ...
        self.closer_frame_distance = rospy.get_param("~closer_frame_distance", 1.5)
        self.front_view_distance = rospy.get_param("~front_view_distance", 1.5)
