...
class PoolBoundaryDetector:
    def __init__(self):
        ...
        self.min_distance_between_points = rospy.get_param('~min_distance_between_points', 0.02)
        ...
        self.cluster_distance = rospy.get_param('~cluster_distance', 1)  # DBSCAN mesafe eşiği
