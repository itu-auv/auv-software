...
class ImageRotator:
    def __init__(self):
        ...
        self.output_topic = rospy.get_param('~output_topic', 'camera/color/image_rotated')
        ...
        rospy.loginfo(f"Image Rotator node started. Subscribing to '{self.input_topic}' and publishing to '{self.output_topic}'.")
