...
-----------------------
Standalone test script that only runs the valve task.
Runs independently of main_state_machine.
...
def main():
    ...
    valve_coarse_approach_frame = rospy.get_param(
        "~valve_coarse_approach_frame", "valve_coarse_approach_frame"
    )
    valve_approach_frame = rospy.get_param(
