    ...
    def __init__(self):
        ...
        with self.sm:
            ...
            smach.StateMachine.add(
                ...
                NavigateThroughGateState(gate_depth=self.gate_depth),
                transitions={
            ...
            smach.StateMachine.add(
                ...
                RotateAroundBuoyState(radius=self.red_buoy_radius, depth=self.red_buoy_depth, direction=self.red_buoy_direction),
                transitions={
            ...
            smach.StateMachine.add(
                ...
                TorpedoTaskState(radius=self.torpedo_map_radius, depth=self.torpedo_map_depth),
                transitions={
            ...
            smach.StateMachine.add(
                ...
                BinTaskState(depth=self.bin_whole_depth),
                transitions={
            ...
            smach.StateMachine.add(
                ...
                OctagonTaskState(depth=self.octagon_depth),
                transitions={
                    "succeeded": "succeeded",
                    "preempted": "preempted",
                    "aborted": "aborted",
