...
class CheckValveEngagementState(smach.State):
    ...
    def __init__(
        ...
        gripper_frame: str,
        valve_frame: str,
        perpendicular_threshold: float = 0.03,
        in_plane_threshold: float = 0.04,
...
class ValveTaskState(smach.State):
    ...
    def __init__(
        ...
        turn_direction: str = "",
        turn_degrees: float = 110.0,
        engage_perpendicular_threshold: float = 0.03,
        engage_in_plane_threshold: float = 0.04,
